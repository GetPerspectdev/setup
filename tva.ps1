...
$baseURL = 'https://api.getperspect.dev/profile-api/public/tva/setup/'
...
Write-Host "`nYou've completed the first step of setting up Perspect!🎉`nNext, go to https://app.perspect.xyz/sources and follow the instructions to set up the sources that you work with the most"